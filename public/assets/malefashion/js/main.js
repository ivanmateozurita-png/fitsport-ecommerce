...
(function ($) {
    ...
    $('.search-close-switch').on('click', function () {
        $('.search-model').fadeOut(400, function () {
            // Reset Livewire search input
            $('.search-model input[type="text"]').val('');
            // Trigger input event for Livewire
            $('.search-model input[type="text"]').trigger('input');
        });
    });
    ...
    // Size selection for product details - handle radio properly
    $(".product__details__option__size label").on('click', function () {
        // Remove active from all size labels
